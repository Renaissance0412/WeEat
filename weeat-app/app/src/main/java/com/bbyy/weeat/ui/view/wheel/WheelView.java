...
public class WheelView extends View {
    ...
    private final WheelSelect wheelSelect = new WheelSelect(0, 0, 0, "", 0, 0, 0);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //初始化WheelSelect
        wheelSelect.set(showCount / 2 * itemHeight, width, itemHeight, selectTip, fontColor, fontSize, padding);
        //得到所有的高度
