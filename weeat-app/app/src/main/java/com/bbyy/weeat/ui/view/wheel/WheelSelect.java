...
public class WheelSelect {
    //黑框背景颜色
    public static final int COLOR_BACKGROUND = Color.parseColor("#AEEB6C61");
    //黑框的Y坐标起点、宽度、高度
    private int startY;
    private int width;
    private int height;
    ...
    public void set(int startY, int width, int height, String selectText, int fontColor, int fontSize, int padding){
        this.startY = startY;
        this.width = width;
        this.height = height;
        this.selectText = selectText;
